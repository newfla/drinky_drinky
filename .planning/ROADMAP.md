...
- [x] 02-01-PLAN.md -- Navigation shell (StatefulShellRoute.indexedStack + NavigationBar), stub screens, add percent_indicator
- [x] 02-02-PLAN.md -- Full home screen: progress ring, quick-add buttons, SnackBar undo, timeline, midnight reset
